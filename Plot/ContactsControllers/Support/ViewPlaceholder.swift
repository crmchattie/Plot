...
enum ViewPlaceholderTitle: String {
    ...
    case emptyLists = "You don't have any lists with tasks yet"
...
enum ViewPlaceholderSubtitle: String {
    ...
    case emptySearch = "You can update the search by adjusting filters in the upper right corner"
    ...
    case emptyLists = "You can add a list or task with the plus button in the upper right corner"
