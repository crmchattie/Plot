...
class EventKitManager {
    ...
    func convertCalendarsToPlot(calendars: [EKCalendar]) -> [CalendarType] {
        ...
        for calendar in calendars {
            let calendarType = CalendarType(id: calendar.calendarIdentifier, name: calendar.title, color: CIColor(cgColor: calendar.cgColor).stringRepresentation, source: CalendarSourceOptions.apple.name, admin: nil)
    ...
    func convertListsToPlot(lists: [EKCalendar]) -> [ListType] {
        ...
        for list in lists {
            let listType = ListType(id: list.calendarIdentifier, name: list.title, color: CIColor(cgColor: list.cgColor).stringRepresentation, source: ListSourceOptions.apple.name, admin: nil)
