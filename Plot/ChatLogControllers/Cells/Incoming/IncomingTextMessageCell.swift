...
//    textView.font = UIFont.systemFont(ofSize: 13)
  ...
  func setupData(message: Message, isGroupChat: Bool) {
    ...
    if isGroupChat {
      ...
      nameLabel.sizeToFit()
      nameLabel.frame.origin = CGPoint(x: textView.textContainerInset.left+5, y: textView.textContainerInset.top-5)
  ...
  override func prepareViewsForReuse() {
    bubbleView.image = grayBubbleImage
    nameLabel.text = ""
    textView.textContainerInset = UIEdgeInsets(top: BaseMessageCell.incomingTextViewTopInset, left: BaseMessageCell.incomingTextViewLeftInset, bottom: BaseMessageCell.incomingTextViewBottomInset, right: BaseMessageCell.incomingTextViewRightInset)
  }
}
