...
final class GoalPickerInlineRow<T> : _GoalPickerInlineRow, RowType, InlineRowType where T: Equatable {
            ...
            case .metric:
                if let value = row.value, let updatedValue = GoalMetric(rawValue: value) {
                    if let goal = row.cell.goal, goal.targetNumber != 0 {
                        row.cell.goal = Goal(name: nil, metric: updatedValue, submetric: nil, option: nil, unit: nil, targetNumber: goal.targetNumber, currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
                    } else {
                        row.cell.goal = Goal(name: nil, metric: updatedValue, submetric: nil, option: nil, unit: nil, targetNumber: nil, currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
                    }
                }
            case .unit:
                if let value = row.value, let updatedValue = GoalUnit(rawValue: value) {
                    if let _ = row.cell.goal {
                        ...
                        row.cell.goal = Goal(name: nil, metric: nil, submetric: nil, option: nil, unit: updatedValue, targetNumber: nil, currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
                    }
                }
            case .submetric:
                if let value = row.value, let updatedValue = GoalSubMetric(rawValue: value) {
                    if let _ = row.cell.goal {
                        ...
                        row.cell.goal = Goal(name: nil, metric: nil, submetric: updatedValue, option: nil, unit: nil, targetNumber: nil, currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
                    }
                }
            case .option:
                if let updatedValue = row.value {
                    if let _ = row.cell.goal {
                        ...
                        row.cell.goal = Goal(name: nil, metric: nil, submetric: nil, option: [updatedValue], unit: nil, targetNumber: nil, currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
                    }
                }
            }
        }
    ...
    @objc func metricTapped(_ sender: UITapGestureRecognizer) {
        ...
        if let goal = cell.goal, let metric = goal.metric {
            ...
            cell.goal = Goal(name: nil, metric: GoalMetric(rawValue: GoalMetric.allValues[0]), submetric: nil, option: nil, unit: nil, targetNumber: nil, currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
            cell.update()
        }
...
//        }
    ...
    @objc func textFieldDidChange(_ textField: UITextField) {
        ...
        if cell.goal != nil {
            ...
            cell.goal = Goal(name: nil, metric: nil, submetric: nil, option: nil, unit: nil, targetNumber: Double(text.filteredNumbers), currentNumber: nil, frequency: nil, metricSecond: nil, submetricSecond: nil, optionSecond: nil, unitSecond: nil, targetNumberSecond: nil, currentNumberSecond: nil, secondMetricType: nil)
        }
