...
//        }
    ...
    func fetchMembersIDs() -> ([String], [String:AnyObject]) {
        ...
        guard let activity = activity, let selectedFalconUsers = selectedFalconUsers, !selectedFalconUsers.isEmpty else {
            if let activity = activity, let id = activity.admin {
