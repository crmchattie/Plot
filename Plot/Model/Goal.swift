...
let savingsGoal = Goal(name: "Savings", metric: GoalMetric.financialTransactions, submetric: GoalSubMetric.group, option: ["Net Savings"], unit: GoalUnit.amount, targetNumber: nil, currentNumber: nil, frequency: PlotRecurrenceFrequency.monthly, metricSecond: GoalMetric.financialTransactions, submetricSecond: GoalSubMetric.group, optionSecond: ["Income"], unitSecond: GoalUnit.percent, targetNumberSecond: 0.2, currentNumberSecond: nil, metricsRelationshipType: MetricsRelationshipType.more)
