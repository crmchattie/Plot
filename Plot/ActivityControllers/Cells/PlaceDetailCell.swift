...
//        label.textColor = FalconPalette.ticketmaster
    ...
    func setupViews() {
        ...
        label.anchor(top: clickView.topAnchor, leading: clickView.leadingAnchor, bottom: nil, trailing: clickView.trailingAnchor, padding: .init(top: 2, left: 15, bottom: 0, right: 15))
        ...
        clickArrowView.centerYAnchor.constraint(equalTo: label.centerYAnchor).isActive = true
