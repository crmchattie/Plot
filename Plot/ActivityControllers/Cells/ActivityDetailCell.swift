...
class ActivityDetailCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        nameLabel.anchor(top: labelView.topAnchor, leading: labelView.leadingAnchor, bottom: nil, trailing: labelView.trailingAnchor, padding: .init(top: 0, left: 5, bottom: 0, right: 0))
        categoryLabel.anchor(top: nameLabel.bottomAnchor, leading: labelView.leadingAnchor, bottom: nil, trailing: labelView.trailingAnchor, padding: .init(top: 0, left: 5, bottom: 0, right: 0))
        subcategoryLabel.anchor(top: categoryLabel.bottomAnchor, leading: labelView.leadingAnchor, bottom: nil, trailing: labelView.trailingAnchor, padding: .init(top: 0, left: 5, bottom: 0, right: 0))
