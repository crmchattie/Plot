//
//  RecipeExpandedDetailViewController.swift
//  Plot
//
...
class RecipeExpandedDetailViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    private let kRecipeDetailViewCell = "RecipeDetailViewCell"
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(RecipeDetailViewCell.self, forCellWithReuseIdentifier: kRecipeDetailViewCell)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if segment == 0, let ingredients = ingredients {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kRecipeDetailViewCell, for: indexPath) as! RecipeDetailViewCell
