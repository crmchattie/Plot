...
enum ViewPlaceholderTitle: String {
    ...
    case emptyEvents = "You don't have any events on this day yet"
    ...
    case emptyTasks = "Could not find any tasks that match the list, filter(s) and/or keyword search"
    ...
    case emptyLists = "You don't have any tasks yet for this list"
...
enum ViewPlaceholderSubtitle: String {
    ...
    case emptyEvents = "Add an event with the plus button in the upper right corner"
    ...
    case emptyTasks = "Add a task with the plus button in the upper right corner, update the filters and/or keyword search"
    ...
    case emptyLists = "You can add a reminder with the plus button in the upper right corner"
