...
class BaseActivityMessageCell: BaseMessageCell {
    ...
    func setupImageFromURL(message: Message, messageImageUrl: URL) {
        if message.activityImageURL == "workout" || message.activityImageURL == "activityLarge" || message.activityImageURL == "food" || message.activityImageURL == "recreation" || message.activityImageURL == "nightlife" || message.activityImageURL == "shopping" || message.activityImageURL == "event" || message.activityImageURL == "sightseeing" || message.activityImageURL == "recipe" || message.activityImageURL == "trending" {
