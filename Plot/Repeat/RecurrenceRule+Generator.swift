...
public extension RecurrenceRule {
    ...
    static func weekendRecurrence() -> RecurrenceRule {
        var recurrenceRule = RecurrenceRule(frequency: .weekly)
        recurrenceRule.interval = 1
        recurrenceRule.byweekday = [.saturday, .sunday]
        return recurrenceRule
    }
    ...
    static func quarterlyRecurrence(withMonthday monthday: Int) -> RecurrenceRule {
        var recurrenceRule = RecurrenceRule(frequency: .monthly)
    ...
    static func semiannualRecurrence(withMonthday monthday: Int) -> RecurrenceRule {
        var recurrenceRule = RecurrenceRule(frequency: .monthly)
        recurrenceRule.interval = 6
        if (-31...31 ~= monthday) && (monthday != 0) {
            recurrenceRule.bymonthday = [monthday]
        }
        return recurrenceRule
